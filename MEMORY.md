...
*   **Release gate**: `pnpm run check:release-gate:ci` validates placeholder checks, core typecheck, and turbo lint. Screenshot verification is opt-in via the strict-visuals variants.
