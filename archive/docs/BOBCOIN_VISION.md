### From docs/PROJECT_VISION_AND_SCOPE.md
...
### From docs/VISION_MASTER.md
At the heart of everything is **Bobcoin**, a cryptocurrency that rewards physical exertion, particularly dancing.
- **StepMania (Experimental):** The modern feature-rich fork based on 5.2+. Integrates Bobcoin economy, online rankings, and modern engine features.
