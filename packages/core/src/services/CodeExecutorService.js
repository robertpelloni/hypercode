...
var CodeExecutorService = /** @class */ (function () {
     ...
     */
    CodeExecutorService.prototype.executeCode = function (code, _toolCallHandler) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var pythonProcess = (0, child_process_1.spawn)('python', ['-c', code]);
                        var stdout = '';
                        var stderr = '';
                        ...
                        pythonProcess.on('close', function (code) {
                            if (code !== 0) {
                                reject(new Error("Python execution failed with code ".concat(code, ":\n").concat(stderr)));
                            }
                            else {
                                resolve(stdout);
                            }
                        ...
                        pythonProcess.on('error', function (err) {
                            reject(new Error("Failed to start Python process: ".concat(err.message)));
                        });
                    })];
            });
        });
