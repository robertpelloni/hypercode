...
var ws_1 = require("ws");
var WebSocketServerTransport = /** @class */ (function () {
    function WebSocketServerTransport(wss) {
        var _this = this;
        this._ws = null;
        this._wss = wss;
    ...
    WebSocketServerTransport.prototype.send = function (message) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    WebSocketServerTransport.prototype.start = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/];
            });
